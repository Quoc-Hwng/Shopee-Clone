          ...
          <div className='grid grid-cols-12 gap-9'>
            <div className='col-span-5'>
              ...
              <div className='relative mt-4 grid grid-cols-5 gap-1'>
                <button className='absolute left-0 top-1/2 z-10 h-9 w-5 -translate-y-1/2'>
                  <svg
                ...
                <button className='absolute right-0 top-1/2 z-10 h-9 w-5 -translate-y-1/2'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    fill='none'
                    viewBox='0 0 24 24'
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center bg-gray-50 px-5 py-4'>
                <div className='text-gray-500 line-through'>₫{formatCurrency(product?.price_before_discount ?? 0)}</div>
                <div className='ml-3 text-3xl font-medium text-orange'>₫{formatCurrency(product?.price ?? 0)}</div>
