...
export default function ProductDetail() {
  ...
  const handleZoom = (event: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    ...
    //C1: Lấy offsetX, offsetY đơn giản khi handle được bubble event
    // const { offsetX, offsetY } = event.nativeEvent
    //C2: Lấy offsetX, offsetY khi không handle được bubble event
  ...
  return (
    <div className='bg-gray-200 py-6'>
          ...
          <div className='grid grid-cols-12 gap-9'>
            <div className='col-span-5'>
              ...
              <div className='relative mt-4 grid grid-cols-5 gap-1'>
                <button className='absolute left-0 top-1/2 z-10 h-9 w-5 -translate-y-1/2' onClick={prev}>
                  <svg
                ...
                <button className='absolute right-0 top-1/2 z-10 h-9 w-5 -translate-y-1/2' onClick={next}>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    fill='none'
                    viewBox='0 0 24 24'
      ...
      <div className='container'>
        <div className='mt-8 bg-white p-4 shadow'>
          <div className='uppercase text-xl font-medium'>Sản phẩm liên quan</div>
          {productsData && (
